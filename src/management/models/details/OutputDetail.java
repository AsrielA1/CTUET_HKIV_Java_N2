...
interface IOutputDetail{
    ...
    void addWeightToOutputHistory(String ouputId, float weight);
    void addOutputDetail(String outputId, int outputNumber, String storageId, float weight);
    
    void addWeightToStorage(String storageId, float weight);
    void minusWeightFromOutputHistory(String outputId, float weight);
...
public class OutputDetail implements IOutputDetail{
    ...
    @Override
    public void addWeightToOutputHistory(String ouputId, float weight){
        Connection connection = null;
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            String query = "UPDATE lichsu_xuatkho SET tong_khoiluong = tong_khoiluong + ? WHERE ma_lohang = ?";
            pstmt = connection.prepareStatement(query);
            
            pstmt.setFloat(1, weight);
            pstmt.setString(2, ouputId);
    ...
    @Override
    public void addOutputDetail(String outputId, int outputNumber, String storageId, float weight){
        Connection connection = null;
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            addWeightToOutputHistory(outputId, weight);
        }
        catch (Exception e){
    ...
    @Override
    public void minusWeightFromOutputHistory(String outputId, float weight){
        Connection connection = null;
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            String query = "UPDATE lichsu_xuatkho SET tong_khoiluong = tong_khoiluong - ? WHERE ma_kho = ?";
            pstmt = connection.prepareStatement(query);
    ...
    public void delOutputDetail(String outputId, int outputNumber){
        ...
        try {
            ...
            String query = "UPDATE chitiet_nhapkho SET ghi_chu = 'Hủy' WHERE ma_nhapkho = ? AND so_thutu = ?;";
            pstmt = connection.prepareStatement(query);
